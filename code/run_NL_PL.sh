...
python run.py \
    --do_train \
    --do_eval \
    --model_type $model_type \  #'codet5'
    --config_name $pretrained_model \  #'Salesforce/codet5-base'
    --tokenizer_name $pretrained_model \    #'Salesforce/codet5-base'
    --model_name_or_path $pretrained_model \    #'Salesforce/codet5-base'
    --train_filename $TRAIN_FILE_SRC,$TRAIN_FILE_TGT \  #'/g4g/XLCoST_data/pair_data_tok_full_desc/-/train---tok','/g4g/XLCoST_data/pair_data_tok_full_desc/-/train---tok'
